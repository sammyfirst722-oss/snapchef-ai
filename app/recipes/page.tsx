...
export const metadata: Metadata = {
  title: '1,200+ Easy Recipes for Leftovers & Quick Dinners | SnapChef AI',
  description:
    'Browse 1,200+ quick, tested recipes for breakfast, lunch, and dinner. Scalable servings, step-by-step instructions, and instant fridge ingredient matching with AI camera vision.',
  openGraph: {
    title: '1,200+ Easy Recipes for Leftovers & Quick Dinners | SnapChef AI',
    description:
      'Browse 1,200+ tested recipes for any meal. Scale servings, check nutrition, or snap a photo of your fridge to find recipes with what you have.',
  },
  alternates: {
